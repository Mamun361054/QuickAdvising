...
public class ListDataAdapterFourth extends ArrayAdapter {
    ...
    public ListDataAdapterFourth(Activity act, int resource) {
        super(act, resource);
        this.activity=act;
            ...
            public void onClick(final View v) {
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        switch (id) {
                            case R.id.edit:
                                Intent update_user = new Intent(activity, AddResultFourth.class);
                                ...
                                adb.setPositiveButton("Ok",
                                        new AlertDialog.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialog,
                                                ...
                                                dBHandler.deleteFromFourthSemseter(SubName);
                                                Intent intent = new Intent(activity, FourthSemester.class);
