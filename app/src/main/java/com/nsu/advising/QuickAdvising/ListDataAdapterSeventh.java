...
public class ListDataAdapterSeventh extends ArrayAdapter {
    ...
    public ListDataAdapterSeventh(Activity act, int resource) {
        super(act, resource);
        this.activity=act;
            ...
            public void onClick(final View v) {
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        switch (id) {
                            case R.id.edit:
                                Intent update_user = new Intent(activity, AddResultSeventh.class);
                                ...
                                adb.setPositiveButton("Ok",
                                        new AlertDialog.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialog,
                                                ...
                                                dBHandler.deleteFromSevenSemester(SubName);
                                                Intent intent = new Intent(activity, SeventhSemester.class);
