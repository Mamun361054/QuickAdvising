...
public class AddResultNineth extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_result_nineth);
        ...
        else
        {
            ...
            Cursor cursor = mydb.searchFromNinethSemester(class_name);
    ...
    public void updateData(View view)
    {
        ...
        long updated = mydb.ninethSemesterUpdate(class_name, Sub, Credit, GPA,Lettergrade,TotalCredit,TotalCrgp);
        ...
        Intent intent = new Intent(AddResultNineth.this, NinethSemester.class);
    ...
    public void savedata(View view)
    {
        ...
        long inserted = mydb.insertNinethSemester(Sub, Credit, GPA,Lettergrade, TotalCredit,TotalCrgp);
        Intent i = new Intent(AddResultNineth.this, NinethSemester.class);
        startActivity(i);
        finish();
    }
