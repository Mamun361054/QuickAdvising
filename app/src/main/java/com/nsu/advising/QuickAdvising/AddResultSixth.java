...
public class AddResultSixth extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_result_sixth);
        ...
        else
        {
            ...
            Cursor cursor = mydb.searchFromSixthSemester(class_name);
    ...
    public void updateData(View view)
    {
        ...
        long updated = mydb.sixthSemesterUpdate(class_name, Sub, Credit, GPA,Lettergrade,TotalCredit,TotalCrgp);
        ...
        Intent intent = new Intent(AddResultSixth.this, SixthSemester.class);
    ...
    public void savedata(View view)
    {
        ...
        long inserted = mydb.insertSixthSemester(Sub, Credit, GPA,Lettergrade, TotalCredit,TotalCrgp);
        Intent i = new Intent(AddResultSixth.this, SixthSemester.class);
        startActivity(i);
        finish();
    }
