...
public class ListDataAdapterThird extends ArrayAdapter {
    ...
    public ListDataAdapterThird(Activity act, int resource) {
        super(act, resource);
        this.activity=act;
            ...
            public void onClick(final View v) {
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        switch (id) {
                            case R.id.edit:
                                Intent update_user = new Intent(activity, AddResultThird.class);
                                ...
                                adb.setPositiveButton("Ok",
                                        new AlertDialog.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialog,
                                                ...
                                                dBHandler.deleteFromFirstSemester(SubName);
                                                Intent intent = new Intent(activity, ThirdSemester.class);
