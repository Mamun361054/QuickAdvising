...
public class AddResultTenth extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_result_tenth);
        ...
        else
        {
            ...
            Cursor cursor = mydb.searchFromTenthSemester(class_name);
    ...
    public void updateData(View view)
    {
        ...
        long updated = mydb.tenthSemesterUpdate(class_name, Sub, Credit, GPA,Lettergrade,TotalCredit,TotalCrgp);
        ...
        Intent intent = new Intent(AddResultTenth.this, TenthSemester.class);
    ...
    public void savedata(View view)
    {
        ...
        long inserted = mydb.insertTenthSemester(Sub, Credit, GPA,Lettergrade, TotalCredit,TotalCrgp);
        Intent i = new Intent(AddResultTenth.this, TenthSemester.class);
        startActivity(i);
        finish();
    }
