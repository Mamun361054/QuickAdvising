...
public class AddResultThird extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_result_third);
        ...
        else
        {
            ...
            Cursor cursor = mydb.searchFromThirdSemester(class_name);
    ...
    public void updateData(View view)
    {
        ...
        long updated = mydb.thirdSemseterUpdate(class_name, Sub, Credit, GPA,Lettergrade,TotalCredit,TotalCrgp);
        ...
        Intent intent = new Intent(AddResultThird.this, ThirdSemester.class);
    ...
    public void savedata(View view)
    {
        ...
        long inserted = mydb.insertThirdSemester(Sub, Credit, GPA,Lettergrade, TotalCredit,TotalCrgp);
        Intent i = new Intent(AddResultThird.this, ThirdSemester.class);
        startActivity(i);
        finish();
    }
