...
public class AddResultFirst extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_result_first);
        ...
        else
        {
            ...
            Cursor cursor = mydb.searchFromFirstSemester(class_name);
    ...
    public void updateData(View view)
    {
        ...
        long updated = mydb.firstSemesterUpdate(class_name, Sub, Credit, GPA,Lettergrade,TotalCredit,TotalCrgp);
        ...
        Intent intent = new Intent(AddResultFirst.this, FirstSemester.class);
    ...
    public void savedata(View view)
    {
        ...
        long inserted = mydb.insertFirstSemester(Sub, Credit, GPA,Lettergrade, TotalCredit,TotalCrgp);
        Intent i = new Intent(AddResultFirst.this, FirstSemester.class);
        startActivity(i);
        finish();
    }
