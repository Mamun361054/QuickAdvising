...
public class AddResultFourth extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_result_fourth);
        ...
        else
        {
            ...
            Cursor cursor = mydb.searchFromFourthSemester(class_name);
    ...
    public void updateData(View view)
    {
        ...
        long updated = mydb.forthSemesterUpdate(class_name, Sub, Credit, GPA,Lettergrade,TotalCredit,TotalCrgp);
        ...
        Intent intent = new Intent(AddResultFourth.this, FourthSemester.class);
    ...
    public void savedata(View view)
    {
        ...
        long inserted = mydb.insertFourthSemester(Sub, Credit, GPA,Lettergrade, TotalCredit,TotalCrgp);
        Intent i = new Intent(AddResultFourth.this, FourthSemester.class);
        startActivity(i);
        finish();
    }
