...
public class AddResultTwelveth extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_result_twelveth);
        ...
        else
        {
            ...
            Cursor cursor = mydb.searchFromTwelvethSemester(class_name);
    ...
    public void updateData(View view)
    {
        ...
        long updated = mydb.twelvethSemesterUpdate(class_name, Sub, Credit, GPA,Lettergrade,TotalCredit,TotalCrgp);
        ...
        Intent intent = new Intent(AddResultTwelveth.this, TwelvethSemester.class);
    ...
    public void savedata(View view)
    {
        ...
        long inserted = mydb.insertTwelvethSemester(Sub, Credit, GPA,Lettergrade, TotalCredit,TotalCrgp);
        Intent i = new Intent(AddResultTwelveth.this, TwelvethSemester.class);
        startActivity(i);
        finish();
    }
