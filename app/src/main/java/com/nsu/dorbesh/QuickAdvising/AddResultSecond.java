...
public class AddResultSecond extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_result_second);
        ...
        else
        {
            ...
            Cursor cursor = mydb.searchFromSecondSemester(class_name);
    ...
    public void updateData(View view)
    {
        ...
        long updated = mydb.secondSemesterUpdate(class_name, Sub, Credit, GPA,Lettergrade,TotalCredit,TotalCrgp);
        ...
        Intent intent = new Intent(AddResultSecond.this, SecondSemester.class);
    ...
    public void savedata(View view)
    {
        ...
        long inserted = mydb.insertSecondSemester(Sub, Credit, GPA,Lettergrade, TotalCredit,TotalCrgp);
        Intent i = new Intent(AddResultSecond.this, SecondSemester.class);
        startActivity(i);
        finish();
    }
