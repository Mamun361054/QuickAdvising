...
public class AddResultSeventh extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_result_seventh);
        ...
        else
        {
            ...
            Cursor cursor = mydb.searchFromSevenSemester(class_name);
    ...
    public void updateData(View view)
    {
        ...
        long updated = mydb.sevenSemesterUpdate(class_name, Sub, Credit, GPA,Lettergrade,TotalCredit,TotalCrgp);
        ...
        Intent intent = new Intent(AddResultSeventh.this, SeventhSemester.class);
    ...
    public void savedata(View view)
    {
        ...
        long inserted = mydb.insertSeventhSemester(Sub, Credit, GPA,Lettergrade, TotalCredit,TotalCrgp);
        Intent i = new Intent(AddResultSeventh.this, SeventhSemester.class);
        startActivity(i);
        finish();
    }
