...
public class AddResultEighth extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_result_eighth);
        ...
        else
        {
            ...
            Cursor cursor = mydb.searchFromEightSemester(class_name);
    ...
    public void updateData(View view)
    {
        ...
        long updated = mydb.eighthSemesterUpdate(class_name, Sub, Credit, GPA,Lettergrade,TotalCredit,TotalCrgp);
        ...
        Intent intent = new Intent(AddResultEighth.this, EighthSemester.class);
    ...
    public void savedata(View view)
    {
        ...
        long inserted = mydb.insertEighthSemester(Sub, Credit, GPA,Lettergrade, TotalCredit,TotalCrgp);
        Intent i = new Intent(AddResultEighth.this, EighthSemester.class);
        startActivity(i);
        finish();
    }
